...
#define CFG_GLFW_WINDOW_TITLE Menu
...
class c_Game_app : public c_App{
	...
	c_Image* m_Set4;
	c_Image* m_GrabSet;
	c_Image* m_AnimationSheet;
	c_Sound* m_Welcome;
	c_Sound* m_Nbidia;
	c_Image* m_Map;
	c_Image* m_CollisionBox;
	c_Image* m_CollisionBoxShow;
	Array<int > m_MenuPointer;
	c_Game_app();
	c_Game_app* m_new();
	void p_FlushVariables();
	void p_LoadFiles(String);
	int p_OnCreate();
	void p_MenuButtons(int,int);
	int p_Menus(int);
	void p_MenuInitializer();
	int p_OnUpdate();
	int p_OnRender();
	void mark();
	String debug();
...
c_Game_app::c_Game_app(){
	...
	m_Map=0;
	m_CollisionBox=0;
	m_CollisionBoxShow=0;
	int t_[]={0,0,0};
	m_MenuPointer=Array<int >(t_,3);
}
c_Game_app* c_Game_app::m_new(){
	DBG_ENTER("Game_app.new")
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<17>");
	c_App::m_new();
	return this;
}
void c_Game_app::p_FlushVariables(){
	DBG_ENTER("Game_app.FlushVariables")
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<221>");
	m_GameState=String();
	DBG_INFO("E:/Computing/Current Version/Test.monkey<222>");
	m_CurrentFrame=0;
	DBG_INFO("E:/Computing/Current Version/Test.monkey<223>");
	m_Set1=0;
	DBG_INFO("E:/Computing/Current Version/Test.monkey<224>");
	m_Set2=0;
	DBG_INFO("E:/Computing/Current Version/Test.monkey<225>");
	m_Set3=0;
	DBG_INFO("E:/Computing/Current Version/Test.monkey<226>");
	m_Set4=0;
	DBG_INFO("E:/Computing/Current Version/Test.monkey<227>");
	m_GrabSet=0;
}
void c_Game_app::p_LoadFiles(String t_Where){
	...
	DBG_INFO("E:/Computing/Current Version/Test.monkey<177>");
	String t_4=t_Where;
	DBG_LOCAL(t_4,"4")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<179>");
	if(t_4==String(L"MainMenu",8)){
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<181>");
		bb_app_SetUpdateRate(7);
		DBG_INFO("E:/Computing/Current Version/Test.monkey<183>");
		gc_assign(m_AnimationSheet,bb_graphics_LoadImage(String(L"Opening.png",11),1,c_Image::m_DefaultFlags));
		DBG_INFO("E:/Computing/Current Version/Test.monkey<185>");
		gc_assign(m_Set1,m_AnimationSheet->p_GrabImage(0,0,1280,720,9,c_Image::m_DefaultFlags));
		DBG_INFO("E:/Computing/Current Version/Test.monkey<186>");
		gc_assign(m_Set2,m_AnimationSheet->p_GrabImage(0,720,1280,720,9,c_Image::m_DefaultFlags));
		DBG_INFO("E:/Computing/Current Version/Test.monkey<187>");
		gc_assign(m_Set3,m_AnimationSheet->p_GrabImage(0,1440,1280,720,9,c_Image::m_DefaultFlags));
		DBG_INFO("E:/Computing/Current Version/Test.monkey<188>");
		gc_assign(m_Set4,m_AnimationSheet->p_GrabImage(0,2160,1280,720,9,c_Image::m_DefaultFlags));
		DBG_INFO("E:/Computing/Current Version/Test.monkey<190>");
		m_GameState=String(L"MainMenu",8);
		DBG_INFO("E:/Computing/Current Version/Test.monkey<191>");
		gc_assign(m_GrabSet,m_Set1);
		DBG_INFO("E:/Computing/Current Version/Test.monkey<192>");
		m_CurrentFrame=0;
		DBG_INFO("E:/Computing/Current Version/Test.monkey<194>");
		gc_assign(m_Welcome,bb_audio_LoadSound(String(L"Welcome.wav",11)));
		DBG_INFO("E:/Computing/Current Version/Test.monkey<195>");
		gc_assign(m_Nbidia,bb_audio_LoadSound(String(L"Nbidia.wav",10)));
	}else{
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<199>");
		if(t_4==String(L"Game",4)){
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<202>");
			bb_app_SetUpdateRate(60);
			DBG_INFO("E:/Computing/Current Version/Test.monkey<204>");
			m_GameState=String(L"Game",4);
			DBG_INFO("E:/Computing/Current Version/Test.monkey<206>");
			m_AnimationSheet=0;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<207>");
			gc_assign(m_Map,bb_graphics_LoadImage(String(L"Map.png",7),1,c_Image::m_DefaultFlags));
			DBG_INFO("E:/Computing/Current Version/Test.monkey<209>");
			gc_assign(m_CollisionBox,bb_graphics_LoadImage(String(L"CollionBox.png",14),1,c_Image::m_DefaultFlags));
			DBG_INFO("E:/Computing/Current Version/Test.monkey<210>");
			gc_assign(m_CollisionBoxShow,bb_graphics_LoadImage(String(L"CollisionBoxShow.png",20),1,c_Image::m_DefaultFlags));
		}
	}
}
int c_Game_app::p_OnCreate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<52>");
	p_FlushVariables();
	DBG_INFO("E:/Computing/Current Version/Test.monkey<60>");
	p_LoadFiles(String(L"MainMenu",8));
	return 0;
}
void c_Game_app::p_MenuButtons(int t_x,int t_y){
	DBG_ENTER("Game_app.MenuButtons")
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x,"x")
	DBG_LOCAL(t_y,"y")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<283>");
	m_MenuPointer.At(2)=(String(m_MenuPointer.At(0))+String(m_MenuPointer.At(1))).ToInt();
	DBG_INFO("E:/Computing/Current Version/Test.monkey<285>");
	if((bb_input_KeyHit(38))!=0){
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<287>");
		if(m_MenuPointer.At(1)==0){
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<289>");
			m_MenuPointer.At(1)=t_y;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<290>");
			m_CurrentFrame+=(t_x+1)*t_y;
		}else{
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<293>");
			m_MenuPointer.At(1)-=1;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<294>");
			m_CurrentFrame-=t_x+1;
		}
	}
	DBG_INFO("E:/Computing/Current Version/Test.monkey<299>");
	if((bb_input_KeyHit(40))!=0){
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<301>");
		if(m_MenuPointer.At(1)==t_y){
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<303>");
			m_MenuPointer.At(1)=0;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<304>");
			m_CurrentFrame-=(t_x+1)*t_y;
		}else{
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<308>");
			m_MenuPointer.At(1)+=1;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<309>");
			m_CurrentFrame+=t_x+1;
		}
	}
	DBG_INFO("E:/Computing/Current Version/Test.monkey<319>");
	if((bb_input_KeyHit(37))!=0){
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<321>");
		if(m_MenuPointer.At(0)==0){
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<323>");
			m_MenuPointer.At(0)=t_x;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<324>");
			m_CurrentFrame+=t_x;
		}else{
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<327>");
			m_MenuPointer.At(0)-=1;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<328>");
			m_CurrentFrame-=1;
		}
	}
	DBG_INFO("E:/Computing/Current Version/Test.monkey<333>");
	if((bb_input_KeyHit(39))!=0){
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<335>");
		if(m_MenuPointer.At(0)==t_x){
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<337>");
			m_MenuPointer.At(0)=0;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<338>");
			m_CurrentFrame-=t_x;
		}else{
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<342>");
			m_MenuPointer.At(0)+=1;
			DBG_INFO("E:/Computing/Current Version/Test.monkey<343>");
			m_CurrentFrame+=1;
		}
	}
	DBG_INFO("E:/Computing/Current Version/Test.monkey<350>");
	if((bb_input_KeyHit(39))!=0){
		DBG_BLOCK();
		m_MenuPointer.At(0)+=1;
	}
	DBG_INFO("E:/Computing/Current Version/Test.monkey<351>");
	if((bb_input_KeyHit(37))!=0){
		DBG_BLOCK();
		m_MenuPointer.At(0)-=1;
	}
	DBG_INFO("E:/Computing/Current Version/Test.monkey<354>");
	if(m_MenuPointer.At(0)<0){
		DBG_BLOCK();
		m_MenuPointer.At(0)=t_x;
	}
	DBG_INFO("E:/Computing/Current Version/Test.monkey<355>");
	if(m_MenuPointer.At(0)>t_x){
		DBG_BLOCK();
		m_MenuPointer.At(0)=0;
	}
}
int c_Game_app::p_Menus(int t_A){
	DBG_ENTER("Game_app.Menus")
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_A,"A")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<235>");
	String t_5=m_GameState;
	DBG_LOCAL(t_5,"5")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<236>");
	if(t_5==String(L"MainMenu",8)){
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<238>");
		int t_6=t_A;
		DBG_LOCAL(t_6,"6")
		DBG_INFO("E:/Computing/Current Version/Test.monkey<240>");
		if(t_6==0){
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<241>");
			m_GameState=String(L"Character Select",16);
		}else{
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<242>");
			if(t_6==1){
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<243>");
				m_GameState=String(L"Game",4);
			}else{
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<246>");
				if(t_6==2){
					DBG_BLOCK();
					DBG_INFO("E:/Computing/Current Version/Test.monkey<247>");
					bb_app_EndApp();
				}
			}
		}
		...
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<250>");
		if(t_5==String(L"CharacterSelect",15)){
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<252>");
			int t_7=t_A;
			DBG_LOCAL(t_7,"7")
			DBG_INFO("E:/Computing/Current Version/Test.monkey<253>");
			if(t_7==0){
				DBG_BLOCK();
			}else{
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<256>");
				if(t_7==10){
					DBG_BLOCK();
				}else{
					DBG_BLOCK();
					DBG_INFO("E:/Computing/Current Version/Test.monkey<258>");
					if(t_7==1){
						DBG_BLOCK();
					}
				}
			...
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<263>");
			if(t_5==String(L"Pause",5)){
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<265>");
				int t_8=t_A;
				DBG_LOCAL(t_8,"8")
				DBG_INFO("E:/Computing/Current Version/Test.monkey<266>");
				if(t_8==0){
					DBG_BLOCK();
					DBG_INFO("E:/Computing/Current Version/Test.monkey<268>");
					m_GameState=String(L"MainMenu",8);
				}else{
					DBG_BLOCK();
					DBG_INFO("E:/Computing/Current Version/Test.monkey<269>");
					if(t_8==10){
						DBG_BLOCK();
					}else{
						DBG_BLOCK();
						DBG_INFO("E:/Computing/Current Version/Test.monkey<271>");
						if(t_8==20){
							DBG_BLOCK();
							DBG_INFO("E:/Computing/Current Version/Test.monkey<272>");
							bb_app_EndApp();
						}
					}
				}
...
void c_Game_app::p_MenuInitializer(){
	DBG_ENTER("Game_app.MenuInitializer")
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<363>");
	m_MenuPointer.At(0)=0;
	DBG_INFO("E:/Computing/Current Version/Test.monkey<364>");
	m_MenuPointer.At(1)=0;
	DBG_INFO("E:/Computing/Current Version/Test.monkey<365>");
	m_MenuPointer.At(2)=0;
}
int c_Game_app::p_OnUpdate(){
	DBG_ENTER("Game_app.OnUpdate")
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<71>");
	String t_1=m_GameState;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<72>");
	if(t_1==String(L"MainMenu",8)){
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<75>");
		c_Image* t_2=m_GrabSet;
		DBG_LOCAL(t_2,"2")
		DBG_INFO("E:/Computing/Current Version/Test.monkey<77>");
		if(t_2==m_Set1){
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<79>");
			if(m_CurrentFrame==8){
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<80>");
				m_CurrentFrame=0;
				DBG_INFO("E:/Computing/Current Version/Test.monkey<81>");
				gc_assign(m_GrabSet,m_Set2);
			}else{
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<90>");
				m_CurrentFrame+=1;
			}
		}else{
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<95>");
			if(t_2==m_Set2){
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<97>");
				if(m_CurrentFrame==8){
					DBG_BLOCK();
					DBG_INFO("E:/Computing/Current Version/Test.monkey<98>");
					m_CurrentFrame=0;
					DBG_INFO("E:/Computing/Current Version/Test.monkey<99>");
					gc_assign(m_GrabSet,m_Set3);
				}else{
					DBG_BLOCK();
					DBG_INFO("E:/Computing/Current Version/Test.monkey<103>");
					if(m_CurrentFrame==3){
						DBG_BLOCK();
						bb_audio_PlaySound(m_Welcome,0,0);
					}
					DBG_INFO("E:/Computing/Current Version/Test.monkey<104>");
					m_CurrentFrame+=1;
				}
			}else{
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<108>");
				if(t_2==m_Set3){
					DBG_BLOCK();
					DBG_INFO("E:/Computing/Current Version/Test.monkey<112>");
					if(m_CurrentFrame==8){
						DBG_BLOCK();
						DBG_INFO("E:/Computing/Current Version/Test.monkey<114>");
						m_CurrentFrame=0;
						DBG_INFO("E:/Computing/Current Version/Test.monkey<115>");
						gc_assign(m_GrabSet,m_Set4);
						DBG_INFO("E:/Computing/Current Version/Test.monkey<116>");
						bb_audio_PlayMusic(String(L"BackM.wav",9),1);
					}else{
						DBG_BLOCK();
						DBG_INFO("E:/Computing/Current Version/Test.monkey<120>");
						m_CurrentFrame+=1;
					}
				}else{
					DBG_BLOCK();
					DBG_INFO("E:/Computing/Current Version/Test.monkey<124>");
					if(t_2==m_Set4){
						DBG_BLOCK();
						DBG_INFO("E:/Computing/Current Version/Test.monkey<127>");
						p_MenuButtons(0,2);
						DBG_INFO("E:/Computing/Current Version/Test.monkey<131>");
						if((bb_input_KeyHit(13))!=0){
							DBG_BLOCK();
							DBG_INFO("E:/Computing/Current Version/Test.monkey<134>");
							p_Menus(m_MenuPointer.At(2));
							DBG_INFO("E:/Computing/Current Version/Test.monkey<135>");
							p_MenuInitializer();
						}
					}
				}
...
int c_Game_app::p_OnRender(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<152>");
	String t_3=m_GameState;
	DBG_LOCAL(t_3,"3")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<154>");
	if(t_3==String(L"MainMenu",8)){
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<156>");
		bb_graphics_DrawImage(m_GrabSet,FLOAT(0.0),FLOAT(0.0),m_CurrentFrame);
	}else{
		DBG_BLOCK();
		DBG_INFO("E:/Computing/Current Version/Test.monkey<159>");
		if(t_3==String(L"CharacterSelect",15)){
			DBG_BLOCK();
		}else{
			DBG_BLOCK();
			DBG_INFO("E:/Computing/Current Version/Test.monkey<161>");
			if(t_3==String(L"Game",4)){
				DBG_BLOCK();
				DBG_INFO("E:/Computing/Current Version/Test.monkey<163>");
				bb_graphics_DrawImage(m_Map,FLOAT(0.0),FLOAT(0.0),0);
				DBG_INFO("E:/Computing/Current Version/Test.monkey<165>");
				bb_graphics_DrawImage(m_CollisionBox,FLOAT(0.0),FLOAT(0.0),0);
			}
		}
	}
	return 0;
...
void c_Game_app::mark(){
	...
	gc_mark_q(m_Set4);
	gc_mark_q(m_GrabSet);
	gc_mark_q(m_AnimationSheet);
	gc_mark_q(m_Welcome);
	gc_mark_q(m_Nbidia);
	gc_mark_q(m_Map);
	gc_mark_q(m_CollisionBox);
	gc_mark_q(m_CollisionBoxShow);
	gc_mark_q(m_MenuPointer);
}
String c_Game_app::debug(){
	String t="(Game_app)\n";
	t=c_App::debug()+t;
	t+=dbg_decl("Set1",&m_Set1);
	t+=dbg_decl("Set2",&m_Set2);
	t+=dbg_decl("Set3",&m_Set3);
	t+=dbg_decl("Set4",&m_Set4);
	t+=dbg_decl("CurrentFrame",&m_CurrentFrame);
	t+=dbg_decl("GrabSet",&m_GrabSet);
	t+=dbg_decl("GameState",&m_GameState);
	t+=dbg_decl("MenuPointer",&m_MenuPointer);
	t+=dbg_decl("AnimationSheet",&m_AnimationSheet);
	t+=dbg_decl("Welcome",&m_Welcome);
	t+=dbg_decl("Nbidia",&m_Nbidia);
	t+=dbg_decl("Map",&m_Map);
	t+=dbg_decl("CollisionBox",&m_CollisionBox);
	t+=dbg_decl("CollisionBoxShow",&m_CollisionBoxShow);
	return t;
}
c_App* bb_app__app;
...
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("E:/Computing/Current Version/Test.monkey<13>");
